        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              <li><Link href="/relocating-to-san-diego" className="text-white/90 hover:text-white">Relocating to San Diego</Link></li>
              <li><Link href="/moving-to-la-jolla" className="text-white/90 hover:text-white">Moving to La Jolla</Link></li>
              <li><Link href="/neighborhoods" className="text-white/90 hover:text-white">Neighborhoods</Link></li>
              <li><Link href="/search-homes" className="text-white/90 hover:text-white">Search Homes</Link></li>
              <li><Link href="/first-time-home-buyer-san-diego" className="text-white/90 hover:text-white">First-Time Buyers</Link></li>
              <li><Link href="/military-va-relocation-san-diego" className="text-white/90 hover:text-white">Military / VA</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              ...
              <li><Link href="/contact" className="text-white/90 hover:text-white">Request Custom Search</Link></li>
