...
export const routes: RouteEntry[] = [
  ...
  // --- noindex, follow: crawl parents and deferred inventory (docs/seo-rebuild-plan.md §12) ---
  {
    ...
    changeFrequency: "monthly",
    priority: 0,
    notes: "Crawl/breadcrumb parent for the 43 guides. Kept noindex,follow rather than 301'd so the guides stay reachable. robots.txt still allows /neighborhoods/.",
  },
  {
    path: "/search-homes",
  ...
  },
  {
    ...
    primaryKeyword: "(deferred — folded into /affordable-neighborhoods-san-diego and /moving-to-san-diego)",
    cluster: "utility",
    indexable: false,
    inSitemap: false,
    changeFrequency: "monthly",
