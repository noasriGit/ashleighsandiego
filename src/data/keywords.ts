...
export const keywordMappings: KeywordMapping[] = [
  ...
  { keyword: "San Diego relocation realtor", page: "/moving-to-san-diego", intent: "relocation" },
  { keyword: "San Diego relocation real estate agent", page: "/moving-to-san-diego", intent: "relocation" },
  ...
  { keyword: "relocating to La Jolla", page: "/la-jolla-neighborhoods", intent: "relocation" },
  { keyword: "living in La Jolla", page: "/neighborhoods/la-jolla", intent: "community-guide" },
  { keyword: "La Jolla relocation realtor", page: "/la-jolla-neighborhoods", intent: "relocation" },
  { keyword: "La Jolla homes for sale", page: "/search-homes", intent: "homes-for-sale" },
  // Military
  { keyword: "military relocation San Diego", page: "/military-realtor-san-diego", intent: "military" },
  ...
  { keyword: "homes near Naval Base San Diego", page: "/military-realtor-san-diego", intent: "military" },
  { keyword: "homes near MCAS Miramar", page: "/military-realtor-san-diego", intent: "military" },
  // First-time buyer
  ...
  { keyword: "san diego neighborhoods map", page: "/san-diego-neighborhood-map", intent: "relocation" },
  { keyword: "map of san diego neighborhoods", page: "/san-diego-neighborhood-map", intent: "relocation" },
  { keyword: "san diego communities map", page: "/san-diego-neighborhood-map", intent: "relocation" },
  { keyword: "moving to san diego", page: "/moving-to-san-diego", intent: "relocation" },
  { keyword: "relocating to san diego", page: "/moving-to-san-diego", intent: "relocation" },
  ...
  { keyword: "condos for sale in mission valley san diego", page: "/mission-valley-condos-for-sale", intent: "homes-for-sale" },
  { keyword: "mission valley condos for sale", page: "/mission-valley-condos-for-sale", intent: "homes-for-sale" },
  { keyword: "mission valley condos", page: "/mission-valley-condos-for-sale", intent: "homes-for-sale" },
  { keyword: "mission valley townhomes", page: "/mission-valley-condos-for-sale", intent: "homes-for-sale" },
  { keyword: "mission valley condo communities", page: "/mission-valley-condos-for-sale", intent: "homes-for-sale" },
